...
* [Balanced Employee IP Agreement](https://github.com/github/balanced-employee-ip-agreement) ⭐ 2,240 | 🐛 14 | 📅 2026-09-10 - Reusable agreement which makes sure employees keep the rights on side projects they do not do as part of their job
...
* [Vouch](https://github.com/mitchellh/vouch) ⭐ 5,110 | 🐛 16 | 🌐 Nushell | 📅 2026-08-23 - A system to manage trust in contributors
...
* [Contributing Template](https://github.com/nayafia/contributing-template) ⭐ 737 | 🐛 3 | 📅 2022-05-24 - Template for contribution guidelines
...
* [First Contributions](https://github.com/firstcontributions/first-contributions/blob/master/README.md) ⭐ 56,002 | 🐛 246 | 📅 2026-09-20 - Playground for learning the GitHub contribution process by doing it at an example
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,456 | 🐛 1 | 📅 2026-09-17 - A curated list of awesome READMEs
* [Beautiful docs](https://github.com/PharkMillups/beautiful-docs/) ⭐ 9,531 | 🐛 2 | 📅 2026-08-27 - Lists of examples of great documentation and tools to generate documentation
...
* [Nadya Eghbal's "Lemonade Stand"](https://github.com/nayafia/lemonade-stand) ⭐ 7,692 | 🐛 16 | 📅 2025-08-06 - A comprehensive list of funding methods for open source projects
...
* [publiccode.yml](https://github.com/publiccodeyml/publiccode.yml) ⭐ 194 | 🐛 33 | 🌐 Python | 📅 2026-09-19 - Standard to express meta data for a repository, used in code for public administration
