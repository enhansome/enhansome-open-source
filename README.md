# Awesome Open Source with stars
...
* [Open Source License Compliance Handbook](https://github.com/finos-osr/OSLC-handbook) ⭐ 137 | 🐛 11 | 🌐 HTML | 📅 2026-05-25 - Detailed guideline how to comply to a large selection of open source licenses
...
* [Balanced Employee IP Agreement](https://github.com/github/balanced-employee-ip-agreement) ⭐ 2,236 | 🐛 13 | 📅 2026-07-18 - Reusable agreement which makes sure employees keep the rights on side projects they do not do as part of their job
...
* [Vouch](https://github.com/mitchellh/vouch) ⭐ 5,053 | 🐛 16 | 🌐 Nushell | 📅 2026-08-09 - A system to manage trust in contributors
...
* [Open Source Governance Models](https://github.com/cornelius/open-source-governance) ⭐ 17 | 🐛 6 | 🌐 Ruby | 📅 2022-02-08 - Collection of data about open source governance models
* [Contributions and credit policy for open source projects](https://github.com/contribution-credit/policy) ⭐ 15 | 🐛 0 | 📅 2024-08-15 - Guide on how to write contribution and credit policies
* [Governance Game](https://github.com/publiccodenet/governance-game) ⭐ 5 | 🐛 0 | 📅 2024-03-06 - Card game to explore governance of open source projects in the public sector
...
* [Public Issue Tracker Behaviors](https://github.com/bradfitz/issue-tracker-behaviors) ⭐ 641 | 🐛 5 | 📅 2023-08-17 - List of bad behaviors in issue trackers you better avoid

### Development

* [Contributing Template](https://github.com/nayafia/contributing-template) ⭐ 735 | 🐛 3 | 📅 2022-05-24 - Template for contribution guidelines
...
* [First Contributions](https://github.com/firstcontributions/first-contributions/blob/master/README.md) ⭐ 55,460 | 🐛 172 | 📅 2026-08-13 - Playground for learning the GitHub contribution process by doing it at an example
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,311 | 🐛 1 | 📅 2026-07-27 - A curated list of awesome READMEs
* [Beautiful docs](https://github.com/PharkMillups/beautiful-docs/) ⭐ 9,519 | 🐛 4 | 📅 2026-03-03 - Lists of examples of great documentation and tools to generate documentation
...
* [Nadya Eghbal's "Lemonade Stand"](https://github.com/nayafia/lemonade-stand) ⭐ 7,683 | 🐛 16 | 📅 2025-08-06 - A comprehensive list of funding methods for open source projects
...
* [publiccode.yml](https://github.com/publiccodeyml/publiccode.yml) ⭐ 189 | 🐛 25 | 🌐 HTML | 📅 2026-07-28 - Standard to express meta data for a repository, used in code for public administration
