...
* [Vouch](https://github.com/mitchellh/vouch) ⭐ 5,095 | 🐛 16 | 🌐 Nushell | 📅 2026-08-23 - A system to manage trust in contributors
...
* [First Contributions](https://github.com/firstcontributions/first-contributions/blob/master/README.md) ⭐ 55,893 | 🐛 216 | 📅 2026-09-11 - Playground for learning the GitHub contribution process by doing it at an example
...
* [publiccode.yml](https://github.com/publiccodeyml/publiccode.yml) ⭐ 192 | 🐛 33 | 🌐 Python | 📅 2026-09-10 - Standard to express meta data for a repository, used in code for public administration
