...
* [Vouch](https://github.com/mitchellh/vouch) ⭐ 5,086 | 🐛 16 | 🌐 Nushell | 📅 2026-08-23 - A system to manage trust in contributors
...
* [First Contributions](https://github.com/firstcontributions/first-contributions/blob/master/README.md) ⭐ 55,838 | 🐛 192 | 📅 2026-09-06 - Playground for learning the GitHub contribution process by doing it at an example
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,417 | 🐛 1 | 📅 2026-08-20 - A curated list of awesome READMEs
